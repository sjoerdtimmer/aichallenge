...
<div class="codehilite"><pre><span class="n">C</span><span class="p">:</span>\<span class="o">&gt;</span><span class="n">python</span>
...
<span class="p">[</span><span class="s">&#39;__doc__&#39;</span><span class="p">,</span> <span class="s">&#39;__name__&#39;</span><span class="p">,</span> <span class="s">&#39;__package__&#39;</span><span class="p">,</span> <span class="s">&#39;acos&#39;</span><span class="p">,</span> <span class="s">&#39;acosh&#39;</span><span class="p">,</span> <span class="s">&#39;asin&#39;</span><span class="p">,</span> <span class="s">&#39;asinh&#39;</span><span class="p">,</span> <span class="s">&#39;atan&#39;</span><span class="p">,</span> <span class="s">&#39;atan2&#39;</span><span class="p">,</span> <span class="s">&#39;atanh&#39;</span><span class="p">,</span> <span class="s">&#39;ceil&#39;</span><span class="p">,</span> <span class="s">&#39;copysign&#39;</span><span class="p">,</span> <span class="s">&#39;cos&#39;</span><span class="p">,</span> <span class="s">&#39;cos</span>
<span class="n">h</span><span class="s">&#39;, &#39;</span><span class="n">degrees</span><span class="s">&#39;, &#39;</span><span class="n">e</span><span class="s">&#39;, &#39;</span><span class="n">erf</span><span class="s">&#39;, &#39;</span><span class="n">erfc</span><span class="s">&#39;, &#39;</span><span class="n">exp</span><span class="s">&#39;, &#39;</span><span class="n">expm1</span><span class="s">&#39;, &#39;</span><span class="n">fabs</span><span class="s">&#39;, &#39;</span><span class="n">factorial</span><span class="s">&#39;, &#39;</span><span class="n">floor</span><span class="s">&#39;, &#39;</span><span class="n">fmod</span><span class="s">&#39;, &#39;</span><span class="n">frexp</span><span class="s">&#39;, &#39;</span><span class="n">fsum</span><span class="s">&#39;, &#39;</span><span class="n">gamma</span><span class="s">&#39;, &#39;</span><span class="n">hypot</span><span class="s">&#39;, &#39;</span><span class="n">isfin</span>
<span class="n">ite</span><span class="s">&#39;, &#39;</span><span class="n">isinf</span><span class="s">&#39;, &#39;</span><span class="n">isnan</span><span class="s">&#39;, &#39;</span><span class="n">ldexp</span><span class="s">&#39;, &#39;</span><span class="n">lgamma</span><span class="s">&#39;, &#39;</span><span class="n">log</span><span class="s">&#39;, &#39;</span><span class="n">log10</span><span class="s">&#39;, &#39;</span><span class="n">log1p</span><span class="s">&#39;, &#39;</span><span class="n">modf</span><span class="s">&#39;, &#39;</span><span class="n">pi</span><span class="s">&#39;, &#39;</span><span class="nb">pow</span><span class="s">&#39;, &#39;</span><span class="n">radians</span><span class="s">&#39;, &#39;</span><span class="n">sin</span><span class="s">&#39;, &#39;</span><span class="n">sinh</span><span class="s">&#39;, &#39;</span><span class="n">sqrt</span><span class="s">&#39;, &#39;</span><span class="n">tan</span><span class="s">&#39;,</span>
<span class="s">&#39;tanh&#39;</span><span class="p">,</span> <span class="s">&#39;trunc&#39;</span><span class="p">]</span>
<span class="o">&gt;&gt;&gt;</span> <span class="n">math</span><span class="o">.</span><span class="n">e</span> <span class="o">**</span> <span class="p">(</span><span class="mi">0j</span> <span class="o">*</span> <span class="n">math</span><span class="o">.</span><span class="n">pi</span><span class="p">)</span>
<span class="p">(</span><span class="mi">1</span><span class="o">+</span><span class="mi">0j</span><span class="p">)</span>
<span class="o">&gt;&gt;&gt;</span> <span class="s">&quot;python&quot;</span><span class="p">[</span><span class="mi">2</span><span class="p">:</span><span class="o">-</span><span class="mi">1</span><span class="p">]</span>
...
<span class="o">&gt;&gt;&gt;</span> <span class="k">def</span> <span class="nf">division</span><span class="p">(</span><span class="n">dividend</span><span class="p">,</span> <span class="n">divisor</span><span class="p">):</span>
...
<span class="o">...</span>
<span class="o">&gt;&gt;&gt;</span> <span class="n">quotient</span><span class="p">,</span> <span class="n">remainder</span> <span class="o">=</span> <span class="n">division</span><span class="p">(</span><span class="mi">17</span><span class="p">,</span><span class="mi">5</span><span class="p">)</span>
<span class="o">&gt;&gt;&gt;</span> <span class="k">print</span><span class="p">(</span><span class="n">quotient</span><span class="p">,</span> <span class="n">remainder</span><span class="p">)</span>
<span class="mi">3</span> <span class="mi">2</span>
<span class="o">&gt;&gt;&gt;</span> <span class="k">print</span><span class="p">(</span><span class="s">&quot;{0} remainder {1}&quot;</span><span class="o">.</span><span class="n">format</span><span class="p">(</span><span class="o">*</span><span class="n">division</span><span class="p">(</span><span class="mi">37</span><span class="p">,</span><span class="mi">7</span><span class="p">)))</span>
...
<span class="s">&#39;C:</span><span class="se">\\</span><span class="s">&#39;</span>
<span class="o">&gt;&gt;&gt;</span> <span class="kn">import</span> <span class="nn">antigravity</span>
<span class="o">&gt;&gt;&gt;</span> <span class="nb">dir</span><span class="p">()</span>
<span class="p">[</span><span class="s">&#39;__builtins__&#39;</span><span class="p">,</span> <span class="s">&#39;__doc__&#39;</span><span class="p">,</span> <span class="s">&#39;__name__&#39;</span><span class="p">,</span> <span class="s">&#39;__package__&#39;</span><span class="p">,</span> <span class="s">&#39;antigravity&#39;</span><span class="p">,</span> <span class="s">&#39;division&#39;</span><span class="p">,</span> <span class="s">&#39;math&#39;</span><span class="p">,</span> <span class="s">&#39;os&#39;</span><span class="p">,</span> <span class="s">&#39;quotient&#39;</span><span class="p">,</span> <span class="s">&#39;remainder&#39;</span><span class="p">]</span>
...
<div class="codehilite"><pre><span class="nl">C:</span><span class="err">\</span><span class="o">&gt;</span><span class="n">notepad</span> <span class="n">prime</span><span class="p">.</span><span class="n">py</span>
</pre></div>
...
<span class="k">def</span> <span class="nf">main</span><span class="p">():</span>
    <span class="n">parser</span> <span class="o">=</span> <span class="n">argparse</span><span class="o">.</span><span class="n">ArgumentParser</span><span class="p">(</span><span class="n">description</span><span class="o">=</span><span class="s">&#39;List prime numbers.&#39;</span><span class="p">)</span>
    <span class="n">parser</span><span class="o">.</span><span class="n">add_argument</span><span class="p">(</span><span class="s">&#39;--max&#39;</span><span class="p">,</span> <span class="nb">type</span><span class="o">=</span><span class="nb">int</span><span class="p">,</span> <span class="n">default</span><span class="o">=</span><span class="mi">100</span><span class="p">,</span>
                        <span class="n">help</span><span class="o">=</span><span class="s">&#39;highest prime number to generate&#39;</span><span class="p">)</span>
    <span class="n">args</span> <span class="o">=</span> <span class="n">parser</span><span class="o">.</span><span class="n">parse_args</span><span class="p">()</span>

    <span class="k">print</span><span class="p">(</span><span class="s">&#39; &#39;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="nb">map</span><span class="p">(</span><span class="nb">str</span><span class="p">,</span> <span class="n">primes</span><span class="p">(</span><span class="n">args</span><span class="o">.</span><span class="n">max</span> <span class="o">+</span> <span class="mi">1</span><span class="p">))))</span>
...
<div class="codehilite"><pre><span class="n">python</span> <span class="n">prime</span><span class="p">.</span><span class="n">py</span> <span class="o">--</span><span class="n">max</span> <span class="mi">1337</span>
</pre></div>
...
<div class="codehilite"><pre><span class="n">python</span> <span class="o">-</span><span class="n">m</span> <span class="n">cProfile</span> <span class="n">prime</span><span class="p">.</span><span class="n">py</span> <span class="o">--</span><span class="n">max</span> <span class="mi">3021377</span>
</pre></div>
...
<div class="codehilite"><pre><span class="n">python</span> <span class="o">-</span><span class="n">m</span> <span class="n">cProfile</span> <span class="n">MyBot</span><span class="p">.</span><span class="n">py</span> <span class="o">&lt;</span> <span class="n">game_lots</span><span class="err">\</span><span class="mf">0.</span><span class="n">bot0</span><span class="p">.</span><span class="n">input</span>
</pre></div>
...
<span class="n">Python</span> <span class="mf">3.2</span><span class="o">.</span><span class="mi">2</span> <span class="p">(</span><span class="n">default</span><span class="p">,</span> <span class="n">Sep</span>  <span class="mi">4</span> <span class="mi">2011</span><span class="p">,</span> <span class="mi">09</span><span class="p">:</span><span class="mi">51</span><span class="p">:</span><span class="mi">08</span><span class="p">)</span> <span class="p">[</span><span class="n">MSC</span> <span class="n">v</span><span class="o">.</span><span class="mi">1500</span> <span class="mi">32</span> <span class="n">bit</span> <span class="p">(</span><span class="n">Intel</span><span class="p">)]</span> <span class="n">on</span> <span class="n">win32</span>
<span class="n">Type</span> <span class="s">&quot;help&quot;</span><span class="p">,</span> <span class="s">&quot;copyright&quot;</span><span class="p">,</span> <span class="s">&quot;credits&quot;</span> <span class="ow">or</span> <span class="s">&quot;license&quot;</span> <span class="k">for</span> <span class="n">more</span> <span class="n">information</span><span class="o">.</span>
<span class="o">&gt;&gt;&gt;</span> <span class="kn">import</span> <span class="nn">prime</span>
<span class="o">&gt;&gt;&gt;</span> <span class="nb">dir</span><span class="p">(</span><span class="n">prime</span><span class="p">)</span>
<span class="p">[</span><span class="s">&#39;__builtins__&#39;</span><span class="p">,</span> <span class="s">&#39;__cached__&#39;</span><span class="p">,</span> <span class="s">&#39;__doc__&#39;</span><span class="p">,</span> <span class="s">&#39;__file__&#39;</span><span class="p">,</span> <span class="s">&#39;__name__&#39;</span><span class="p">,</span> <span class="s">&#39;__package__&#39;</span><span class="p">,</span> <span class="s">&#39;argparse&#39;</span><span class="p">,</span> <span class="s">&#39;floor&#39;</span><span class="p">,</span> <span class="s">&#39;main&#39;</span><span class="p">,</span> <span class="s">&#39;primes&#39;</span><span class="p">,</span> <span class="s">&#39;sqrt&#39;</span><span class="p">]</span>
<span class="o">&gt;&gt;&gt;</span> <span class="n">prime</span><span class="o">.</span><span class="n">primes</span><span class="p">(</span><span class="mi">10</span><span class="p">)</span>
